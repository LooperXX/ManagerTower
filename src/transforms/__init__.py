from .transform import (
    ...
    albef_transform_randaug_wc,
    albef_transform_randaug_wohf,
    albef_transform_randaug_pretrain,
...
_transforms = {
    ...
    "albef_randaug_wc": albef_transform_randaug_wc,
    "albef_randaug_wohf": albef_transform_randaug_wohf,
    "albef_randaug_pretrain": albef_transform_randaug_pretrain,
